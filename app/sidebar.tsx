...
const NAV_ITEMS = [
  ...
  { href: "/schemes", label: "Schemes", icon: CalendarIcon },
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-border bg-panel">
      ...
      <div className="border-t border-border px-6 py-4">
        <p className="text-xs text-ink/30">SG Gold Admin v0.1</p>
      </div>
    </aside>
  );
}
...
/* ------------------------------------------------------------------ */
/*  Inline icon components (avoids extra lucide imports in sidebar)    */
/* ------------------------------------------------------------------ */
